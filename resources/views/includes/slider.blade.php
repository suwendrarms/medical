	...
	<div class="aside-brand d-flex flex-column align-items-center flex-column-auto py-9">					
		<div class="btn p-0 symbol symbol-40 symbol-success" href="?page=index" id="kt_quick_user_toggle">
			<div class="symbol-label">
				<img alt="Logo" src="{{ asset('ui/web//media/svg/avatars/007-boy-2.svg') }}" class="h-75 align-self-end" />
			</div>
		</div>				
    </div>			
</div>
...
<div id="kt_quick_user" class="offcanvas offcanvas-left p-10">
			...
			<!--end::Header-->
			<!--begin::Content-->
			<div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 316px; overflow: hidden;">
				<!--begin::Header-->
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('{{ asset('ui/web//media/svg/avatars/007-boy-2.svg') }}')"></div>
