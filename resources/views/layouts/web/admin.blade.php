...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Aug 2022 08:49:51 GMT -->
...
<head>
		...
		<link rel="shortcut icon" href="{{ asset('ui/media/logos/favicon.ico') }}" />
		<!--begin::Fonts-->
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />
		<!--end::Fonts-->
		<!--begin::Vendor Stylesheets(used by this page)-->
		<link href="{{ asset('ui/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('ui/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet" type="text/css" />
		<!--end::Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(used by all pages)-->
		<link href="{{ asset('ui/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('ui/css/style.bundle.css') }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
								...
								<div class="row g-5">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-success rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="index.html" class="btn btn-sm btn-success shadow">Demo 1</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo2/index.html" class="btn btn-sm btn-success shadow">Demo 2</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo3/index.html" class="btn btn-sm btn-success shadow">Demo 3</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo4/index.html" class="btn btn-sm btn-success shadow">Demo 4</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo5/index.html" class="btn btn-sm btn-success shadow">Demo 5</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo6/index.html" class="btn btn-sm btn-success shadow">Demo 6</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo7/index.html" class="btn btn-sm btn-success shadow">Demo 7</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo8/index.html" class="btn btn-sm btn-success shadow">Demo 8</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo9/index.html" class="btn btn-sm btn-success shadow">Demo 9</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo10/index.html" class="btn btn-sm btn-success shadow">Demo 10</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo11/index.html" class="btn btn-sm btn-success shadow">Demo 11</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo12/index.html" class="btn btn-sm btn-success shadow">Demo 12</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo13/index.html" class="btn btn-sm btn-success shadow">Demo 13</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo14/index.html" class="btn btn-sm btn-success shadow">Demo 14</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo15/index.html" class="btn btn-sm btn-success shadow">Demo 15</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo16/index.html" class="btn btn-sm btn-success shadow">Demo 16</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo17/index.html" class="btn btn-sm btn-success shadow">Demo 17</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo18/index.html" class="btn btn-sm btn-success shadow">Demo 18</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo19/index.html" class="btn btn-sm btn-success shadow">Demo 19</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo20/index.html" class="btn btn-sm btn-success shadow">Demo 20</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo21/index.html" class="btn btn-sm btn-success shadow">Demo 21</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											...
											<div class="overlay-layer bg-dark bg-opacity-10">
												<a href="../demo22/index.html" class="btn btn-sm btn-success shadow">Demo 22</a>
											</div>
										</div>
										<!--end::Demo-->
									</div>
		...
		<script src="{{ asset('ui/assets/plugins/global/plugins.bundle.js') }}"></script>
		<script src="{{ asset('ui/js/scripts.bundle.js') }}"></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Vendors Javascript(used by this page)-->
		<script src="{{ asset('ui/plugins/custom/fullcalendar/fullcalendar.bundle.js') }}"></script>
		...
		<script src="{{ asset('ui/plugins/custom/datatables/datatables.bundle.js') }}"></script>
		<!--end::Vendors Javascript-->
		<!--begin::Custom Javascript(used by this page)-->
		<script src="{{ asset('ui/js/widgets.bundle.js') }}"></script>
		<script src="{{ asset('ui/js/custom/widgets.js') }}"></script>
		<script src="{{ asset('ui/js/custom/apps/chat/chat.js') }}"></script>
		<script src="{{ asset('ui/js/custom/utilities/modals/upgrade-plan.js') }}"></script>
		<script src="{{ asset('ui/js/custom/utilities/modals/create-app.js') }}"></script>
		<script src="{{ asset('ui/js/custom/utilities/modals/new-target.js') }}"></script>
		<script src="{{ asset('ui/js/custom/utilities/modals/users-search.js') }}"></script>
