...
<html lang="en">
	...
	<head><base href="../../../../">
		...
		<link href="{{ asset('ui/web/css/pages/login/classic/login-3.css') }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled sidebar-enabled page-loading">
		...
		<script src="{{ asset('ui/web/js/pages/custom/login/login-general.js') }}"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>