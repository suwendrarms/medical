...
<div class="card card-custom">
	<!-- <div class="card-header flex-wrap border-0 pt-6 pb-0"> -->
      ...
      <input type="hidden" id="prescription_id" name="prescription_id" value="{{$prescription->prescription_id}}"/>
       ...
       <div  class="form-group row" id="add_drug">
           <div class="col-lg-4">      
                <label>Drug:</label>
       ...
       <div  class="form-group row">
           <div class="col-lg-12"> 
              ...
              <table class="table table-bordered" id="tab_table">
                        ...
                        <tr>
                            <th colspan="2"></th>
                            <th>Total : <h4 id="total">Rs. @if($quotations){{$quotations->amount}}@endif</h4></th>
                        </tr>
                </table>
                @hasanyrole('User')
...
<script>
  $( document ).ready(function() {
    ...
    if(data==1){
      ...
      //$("#tab_table").removeClass('d-none');
    }
    else{
      $("#send_q").addClass('d-none');	
      //$("#tab_table").addClass('d-none');
    }
  });
