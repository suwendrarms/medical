...
<div class="modal fade" id="kt_select_modal" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form class="form" method="post" action="{{route('drug.save')}}">
              @csrf
				...
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-md-9 col-sm-12">
							<input type="text" class="form-control" name ="name" id="insurance" required/>						
						</div>
					</div>
                    ...
                    <div class="form-group row">
						...
						<div class="col-lg-9 col-md-9 col-sm-12">
							<input type="text" class="form-control" name ="price" id="insurance" required/>						
						</div>
					</div>
                </div>
				<div class="modal-footer">
					<a href="{{route('drug.index')}}" type="button" class="btn btn-primary mr-2">Close</a>
